...
public class FireBaseUtil {
	...
	private final String BUCKET_NAME = "guiadrog.appspot.com";
	...
	public FireBaseUtil() {
		...
		Resource resource = new ClassPathResource("chave_firebase.json");
	...
	public String upload(MultipartFile arquivo) throws IOException {
		...
		//gravar o blobinfo no Storage passando os bytes
